...
class _PromotionsPageState extends State<PromotionsPage> {
  ...
  Future<_PromotionPreview> _loadPreview() async {
    final league1 =
        await firestoreService.getLeagueTableOnce(league: '1', season: selectedSeason);
    final league2 =
        await firestoreService.getLeagueTableOnce(league: '2', season: selectedSeason);
    final league3 =
        await firestoreService.getLeagueTableOnce(league: '3', season: selectedSeason);
    final league4 =
        await firestoreService.getLeagueTableOnce(league: '4', season: selectedSeason);
  ...
  Future<void> _applyChanges() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Promocije i ispadanja su primijenjeni.'),
        ),
      );
    } catch (e) {
      if (!mounted) return;
