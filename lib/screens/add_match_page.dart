...
class AddMatchPage extends StatefulWidget {
  const AddMatchPage({super.key, this.initialLeague});
...
class _AddMatchPageState extends State<AddMatchPage> {
  ...
  String? get _selectedLeague => widget.initialLeague;
          ...
          final players = (snapshot.data ?? [])
              ...
              .where(
                (player) =>
                    ...
                    LeagueUtils.normalize(player.league) == _selectedLeague,
              )
              .toList();
              ...
              ElevatedButton(
                onPressed: isSaving
                    ...
                    : () async {
                        ...
                        if (LeagueUtils.normalize(player1!.league) !=
                            LeagueUtils.normalize(player2!.league)) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text(
                                'Oba igrača moraju biti iz iste lige',
                              ),
                            ),
                          );
                          return;
                        ...
                        final match = MatchModel(
                          ...
                          league: LeagueUtils.normalize(player1!.league),
