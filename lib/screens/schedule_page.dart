    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              '${selectedSeason.split(' ').first} Round Robin Generator',
              style: Theme.of(
                context,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 6),
            const Text('4. U 4. ligi nema ispadanja, samo promocija top 4.'),
            const SizedBox(height: 6),
            const Text(
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.hasError) {
          return Scaffold(
            ...
            body: Center(child: Text('Greška: ${snapshot.error}')),
          );
        }
        ...
        final rounds = selectedSeason.startsWith('Winter')
            ...
            : selectedSeason.startsWith('Summer')
            ? roundRobinService.generateSummerSchedule(
                players: leaguePlayers,
                league: selectedLeague,
                seasonYear: _seasonYearFromLabel(selectedSeason),
                cycleLabel: 'Cycle 1',
            ...
            children: [
              ...
              Expanded(
                child: leaguePlayers.length < 2
                    ? const Center(
                        child: Text('Nema dovoljno igrača u odabranoj ligi.'),
                      )
                    : ListView(
                        padding: const EdgeInsets.all(16),
                        children: [
