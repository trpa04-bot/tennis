...
class _LeagueManagementPageState extends State<LeagueManagementPage> {
  ...
  List<Player> _playersForLeague(List<Player> players, String league) {
    return players.where((p) => _normalizeLeague(p.league) == league).toList()
  ...
  Future<void> _movePlayerToLeague(Player player, String newLeague) async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('${player.name} prebačen u ${_leagueLabel(newLeague)}.'),
      ),
    );
  }
              ...
              content: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    decoration: const InputDecoration(labelText: 'Nova liga'),
                    items: const [
                      DropdownMenuItem(
                        value: '1',
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(content: Text('${player.name} je obrisan.')),
                );
              },
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: const [
            ...
            SizedBox(height: 8),
            Text('Admin uvijek mora imati zadnju riječ.'),
          ],
        ),
      ),
    );
