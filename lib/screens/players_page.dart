...
class _PlayersPageState extends State<PlayersPage> {
        ...
        return StatefulBuilder(
          builder: (context, setDialogState) {
            Future<void> handleSubmit() async {
              ...
              final appliedRating = parsedRating;
                ...
                if (isEditing) {
                  ...
                  if (!updated) {
                    ScaffoldMessenger.of(pageContext).showSnackBar(
                      const SnackBar(
                        content: Text(
                          'Promjene nisu spremljene. Pokušaj ponovno.',
                        ),
                      ),
                    );
                    return;
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: isEditing
                              ? 'Unesi rating'
                              : 'Ostavi prazno za zadani rating lige',
                        ),
                        validator: (value) {
  ...
  Future<void> _freezePlayer(Player player) async {
    ...
    ScaffoldMessenger.of(
      context,
    ).showSnackBar(SnackBar(content: Text('${player.name} je zamrznut.')));
  }
  ...
  Future<void> _unfreezePlayer(Player player) async {
    ...
    ScaffoldMessenger.of(
      context,
    ).showSnackBar(SnackBar(content: Text('${player.name} je odmrznut.')));
  }
  ...
  Future<void> _archivePlayer(Player player) async {
    ...
    ScaffoldMessenger.of(
      context,
    ).showSnackBar(SnackBar(content: Text('${player.name} je arhiviran.')));
  }
  ...
  Future<void> _recalculateAchievements() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Achievementi su izračunati za sve igrače!'),
      ),
    );
  }
  ...
  void _openPlayerDetails(Player player) {
    if (player.id == null || player.id!.isEmpty) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text('Igrač nema ispravan ID.')));
      return;
    }
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) =>
            PlayerDetailsPage(playerId: player.id!, playerName: player.name),
      ),
    );
  }
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (_) => const ArchivedPlayersPage()),
              );
            },
          ),
        ],
